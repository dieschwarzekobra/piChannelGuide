...
def createHtmlForSoup():
  #Connect to TVRAGE API
  connectToTvRage()

  #Scrape and save TVRAGE page
  #Read into soup variable

########################################################################

def connectToTvRage():
  page = urllib.urlopen("http://services.tvrage.com/tools/quickschedule.php")
  page = page.read()
